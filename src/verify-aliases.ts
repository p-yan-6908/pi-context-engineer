...
const cases: readonly AliasCase[] = [
  ...
  },
  {
    ...
    expected: { kind: "exact", value: 300, unit: "tokens" },
  ...
  },
  {
    ...
    expected: { kind: "exact", value: 1000, unit: "tokens" },
  ...
  },
  {
    ...
    expected: { kind: "exact", value: 100, unit: "bytes" },
  ...
  },
  {
    ...
    program: `const LIMIT = requested + 2048; return extensions.ctx_read({ id: "h", length: LIMIT });`,
    expected: { kind: "unknown", unit: "bytes" },
    reasonIncludes: "length has no provable non-negative safe-integer bound (bytes).",
  },
  {
